...
RegisterServerEvent('pk-gangjob:pakSpelerItem')
AddEventHandler('pk-gangjob:pakSpelerItem', function(target, itemType, itemName, amount)
...
ESX.RegisterServerCallback('pk-gangjob:krijgAndereInventory', function(source, cb, target)
